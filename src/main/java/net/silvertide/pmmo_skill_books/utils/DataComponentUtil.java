...
public final class DataComponentUtil {
    ...
    public static void addSkillGrantData(ItemStack stack, String name, List<String> skills, String applicationType, Long value, int experienceCost, String bookColor, String trimColor) {
        SkillGrantData data = new SkillGrantData(name, skills, applicationType, value, experienceCost, bookColor, trimColor);
